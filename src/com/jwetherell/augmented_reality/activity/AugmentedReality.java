...
public class AugmentedReality extends SensorsActivity implements OnTouchListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LayerDrawable layer = (LayerDrawable) myZoomBar
        	     .getProgressDrawable();
        
        ColorDrawable cdraw1 = new ColorDrawable(Color.rgb(192, 12, 10));
        
        Drawable draw1 = (Drawable) layer
        	     .findDrawableByLayerId(android.R.id.progress);
        draw1 = new ClipDrawable(cdraw1,
        	     Gravity.AXIS_PULL_BEFORE, ClipDrawable.HORIZONTAL);
        
        layer.setDrawableByLayerId(android.R.id.progress, draw1);
        
        ColorDrawable cdraw2 = new ColorDrawable(Color.rgb(100, 100, 100)) ;
        
        Drawable draw2 = (Drawable) layer
       	     .findDrawableByLayerId(android.R.id.background);
        draw2 = new ClipDrawable(cdraw2,
       	     Gravity.AXIS_PULL_BEFORE, ClipDrawable.HORIZONTAL);
       
        layer.setDrawableByLayerId(android.R.id.background, draw2);
        
        myZoomBar.setMax(100);
        myZoomBar.setProgress(90);
        myZoomBar.setOnSeekBarChangeListener(myZoomBarOnSeekBarChangeListener);
        
        endLabel.setText(String.valueOf(calcZoomLevel()) + " km") ;
        //myZoomBar.setProgressDrawable(cd) ;
        ...
        FrameLayout.LayoutParams frameLayoutParams = new FrameLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT, Gravity.RIGHT);
    ...
    private static float calcZoomLevel() {
        ...
        endLabel.setText(String.format("%.1f",myout) + " km") ;
        return myout;
    }
