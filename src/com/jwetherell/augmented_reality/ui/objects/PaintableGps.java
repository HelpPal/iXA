...
public class PaintableGps extends PaintableObject {
    ...
    public PaintableGps(float radius, float strokeWidth, boolean fill, Bitmap color) {
     ...
     */
    public void set(float radius, float strokeWidth, boolean fill, Bitmap color) {
        this.radius = radius;
    ...
    public void paint(Canvas canvas) {
        ...
        canvas.scale(1.0f, 1.0f, x, y);
        if ( color != null )
        	canvas.drawBitmap(color, x, y, null);
