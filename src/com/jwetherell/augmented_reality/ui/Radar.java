...
public class Radar {
    ...
    public static final float RADIUS = 120;

    private static final int LINE_COLOR = Color.argb(150, 220, 220, 220);
    private static final float PAD_X = 10;
    private static final float PAD_Y = 10;
    private static final int RADAR_COLOR = Color.argb(255, 7, 48, 110);
    private static final int TEXT_COLOR = Color.rgb(192, 12, 10);
    ...
    private void drawRadarText(Canvas canvas) {
        ...
        // Azimuth text
        radarText(canvas, RADAR_TXT.toString(), (PAD_X+RADIUS), (PAD_Y-5), false);
