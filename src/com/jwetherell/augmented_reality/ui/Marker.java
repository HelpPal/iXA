...
public class Marker implements Comparable<Marker> {
    ...
    protected PaintableText textBox = null ;
    ...
    public Marker(String name, double latitude, double longitude, double altitude, Bitmap color, 
    		String businessName, String call, String description) {
        set(name, latitude, longitude, altitude, color, businessName, call, description);
    }
     ...
     *            Color of the Marker.
     */
    public void set(String name, double latitude, double longitude, double altitude, Bitmap color, 
    		String businessName, String call, String description) {
        if (name == null)
    ...
    {
    	return this.physicalLocation.getLatitude() ;
    }
    
    public double getLongitude()
    {
    	return this.physicalLocation.getLongitude() ;
    }
    ...
    protected void drawIcon(Canvas canvas) {
        ...
        if (gpsSymbol == null)
        {
        	//if ( getColor() == null )
            //{
        		gpsSymbol = new PaintableGps(36, 8, true, color);
           // }        	
        }        	
    ...
    private void drawText(Canvas canvas) {
        ...
        if ( name.length() > 20 )
        {
        	textStr.append(name.substring(0, 19)) ;
        	textStr.append("...") ;
        }
        else
        	textStr.append(name) ;
        ...
        /*
        if (textBox == null)
            textBox = new PaintableBoxedText(textStr.toString(), Math.round(maxHeight / 2f) + 1, 100);
        else
            textBox.set(textStr.toString(), Math.round(maxHeight / 3f) + 1, 100);

*/
        if ( textBox == null )
        	textBox = new PaintableText(textStr.toString(), Color.rgb(192, 12, 10), 30, true) ;
        else
        	textBox.set(textStr.toString(), Color.rgb(192, 12, 10), 30, true) ;
